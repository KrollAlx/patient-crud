...
var i_34272 = (0);
while(true){
if((i_34272 < arr.length)){
(arr[i_34272] = null);

var G__34273 = (i_34272 + (1));
i_34272 = G__34273;
continue;
} else {
}
...
var i_34280 = (self__.level + (1));
while(true){
if((i_34280 <= (new_level + (1)))){
(update[i_34280] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_34282 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34282[i]));
} else {
x__$2.forward.push((((i < links_34282.length))?(links_34282[i]):null));
}

if((i < links_34282.length)){
(links_34282[i] = x__$2);
} else {
links_34282.push(x__$2);
}
...
var i_34284 = (0);
while(true){
if((i_34284 <= self__.level)){
var links_34285 = (update[i_34284]).forward;
if((x__$1 === (((i_34284 < links_34285.length))?(links_34285[i_34284]):null))){
(links_34285[i_34284] = (x__$1.forward[i_34284]));

var G__34286 = (i_34284 + (1));
i_34284 = G__34286;
continue;
} else {
var G__34287 = (i_34284 + (1));
i_34284 = G__34287;
continue;
}
} else {
...
var G__34289 = nx;
var G__34290 = (level__$1 - (1));
x = G__34289;
level__$1 = G__34290;
continue;
} else {
var G__34291 = x;
var G__34292 = (level__$1 - (1));
x = G__34291;
level__$1 = G__34292;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34294 = nx;
var G__34295 = (level__$1 - (1));
x = G__34294;
level__$1 = G__34295;
continue;
} else {
var G__34296 = x;
var G__34297 = (level__$1 - (1));
x = G__34296;
level__$1 = G__34297;
continue;
}
