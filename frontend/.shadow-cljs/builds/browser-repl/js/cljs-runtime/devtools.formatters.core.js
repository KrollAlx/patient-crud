...
}catch (e28657){var _e__17641__auto__ = e28657;
return false;
...
}catch (e28659){var _e__17641__auto__ = e28659;
return false;
...
}catch (e28661){var _e__17641__auto__ = e28661;
return false;
...
}catch (e28663){var _e__17641__auto__ = e28663;
return false;
...
}catch (e28665){var _e__17641__auto__ = e28665;
return false;
}})())){
...
}catch (e28667){var _e__17641__auto__ = e28667;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__28669 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28670 = (function (){var or__5045__auto__ = config;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28670);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28669);
}});
});
...
return (function() { 
var G__28675__delegate = function (args){
...
while (G__28676__i < G__28676__a.length) {G__28676__a[G__28676__i] = arguments[G__28676__i + 0]; ++G__28676__i;}
  args = new cljs.core.IndexedSeq(G__28676__a,0,null);
} 
return G__28675__delegate.call(this,args);};
G__28675.cljs$lang$maxFixedArity = 0;
G__28675.cljs$lang$applyTo = (function (arglist__28677){
var args = cljs.core.seq(arglist__28677);
return G__28675__delegate(args);
});
