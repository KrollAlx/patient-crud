...
var G__27347 = devtools.prefs.pref(v);
v = G__27347;
continue;
} else {
return v;
...
}catch (e27316){var _e__17641__auto__ = e27316;
return false;
}})();
...
}catch (e27321){var _e__17641__auto__ = e27321;
return false;
}})();
...
}catch (e27325){var _e__17641__auto__ = e27325;
return false;
}}
}
});
...
var vec__27331 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27331,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27331,(1),null);
...
return cljs.core.some((function (p1__27339_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27339_SHARP_);
}),template);
});
