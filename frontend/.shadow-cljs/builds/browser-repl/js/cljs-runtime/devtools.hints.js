...
var map__26096 = top_item;
var map__26096__$1 = cljs.core.__destructure_map(map__26096);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26096__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26096__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26096__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26095){var _e = e26095;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___26116 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___26116)){
var seen_errors_26117 = temp__5802__auto___26116;
if(cljs.core.truth_(seen_errors_26117.has(self))){
} else {
seen_errors_26117.add(self);

var temp__5804__auto___26118 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___26118)){
var sense_26119 = temp__5804__auto___26118;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26119)].join(''));
} else {
}
}
} else {
