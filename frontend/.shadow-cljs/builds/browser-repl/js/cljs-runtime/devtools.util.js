...
var G__27940 = (i__5770__auto___27935 + (1));
i__5770__auto___27935 = G__27940;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__27845_27941 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27846_27942 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27847_27943 = true;
var _STAR_print_fn_STAR__temp_val__27848_27944 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27847_27943);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27848_27944);

try{var _STAR_print_level_STAR__orig_val__27851_27945 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27852_27946 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27852_27946);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27851_27945);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27846_27942);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27845_27941);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq27832){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27832));
}));
...
var new_formatters = current_formatters.filter((function (p1__27861_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__27861_SHARP_)));
}));
...
var G__27863_27949 = f;
var target__17639__auto___27950 = G__27863_27949;
if(cljs.core.truth_(target__17639__auto___27950)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27863_27949)].join(''),"\n","target__17639__auto__"].join('')));
}

(target__17639__auto___27950["toString"] = (function (){
...
var G__27865_27953 = "%c%s";
var G__27866_27954 = "color:transparent";
var G__27867_27955 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__27865_27953,G__27866_27954,G__27867_27955) : f.call(null,G__27865_27953,G__27866_27954,G__27867_27955));
...
var vec__27876 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27876,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27876,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__27961__delegate = function (add_fmt,add_args){
...
var G__27961 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__27962__i = 0, G__27962__a = new Array(arguments.length -  1);
while (G__27962__i < G__27962__a.length) {G__27962__a[G__27962__i] = arguments[G__27962__i + 1]; ++G__27962__i;}
  add_args = new cljs.core.IndexedSeq(G__27962__a,0,null);
} 
return G__27961__delegate.call(this,add_fmt,add_args);};
G__27961.cljs$lang$maxFixedArity = 1;
G__27961.cljs$lang$applyTo = (function (arglist__27964){
var add_fmt = cljs.core.first(arglist__27964);
var add_args = cljs.core.rest(arglist__27964);
return G__27961__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq27870){
...
var G__27873 = cljs.core.first(seq27870__$2);
var seq27870__$3 = cljs.core.next(seq27870__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27871,G__27872,G__27873,seq27870__$3);
}));
...
var seq__27880 = cljs.core.seq(features);
var chunk__27881 = null;
var count__27882 = (0);
var i__27883 = (0);
while(true){
if((i__27883 < count__27882)){
var feature = chunk__27881.cljs$core$IIndexed$_nth$arity$2(null,i__27883);
...
var G__27967 = seq__27880;
var G__27968 = chunk__27881;
var G__27969 = count__27882;
var G__27970 = (i__27883 + (1));
seq__27880 = G__27967;
chunk__27881 = G__27968;
count__27882 = G__27969;
i__27883 = G__27970;
continue;
} else {
...
var G__27971 = cljs.core.chunk_rest(seq__27880__$1);
var G__27972 = c__5568__auto__;
var G__27973 = cljs.core.count(c__5568__auto__);
var G__27974 = (0);
seq__27880 = G__27971;
chunk__27881 = G__27972;
count__27882 = G__27973;
i__27883 = G__27974;
continue;
} else {
var feature = cljs.core.first(seq__27880__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__27976 = cljs.core.next(seq__27880__$1);
var G__27977 = null;
var G__27978 = (0);
var G__27979 = (0);
seq__27880 = G__27976;
chunk__27881 = G__27977;
count__27882 = G__27978;
i__27883 = G__27979;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o27913 = temp__5802__auto__;
return (o27913["version"]);
} else {
return null;
}
})() == null);
