...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__62123){
var map__62124 = p__62123;
var map__62124__$1 = cljs.core.__destructure_map(map__62124);
var ast = map__62124__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62124__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__5043__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__5043__auto__){
var G__62128 = (function (){var or__5045__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__62130 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__62130.cljs$core$IFn$_invoke$arity$1 ? fexpr__62130.cljs$core$IFn$_invoke$arity$1(op) : fexpr__62130.call(null,op));
})())){
...
var fexpr__62127 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__62145_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__62145_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__62178 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__62178,local);
} else {
return G__62178;
}
});
...
var map__62179 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__62179__$1 = cljs.core.__destructure_map(map__62179);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62179__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62179__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__62185 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__62185__$1 = cljs.core.__destructure_map(map__62185);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62185__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62185__$1,new cljs.core.Keyword(null,"name","name",1843675177));
