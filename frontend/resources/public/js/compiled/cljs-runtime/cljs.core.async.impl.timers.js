...
var i_60379 = (self__.level + (1));
while(true){
if((i_60379 <= (new_level + (1)))){
(update[i_60379] = self__.header);

var G__60380 = (i_60379 + (1));
i_60379 = G__60380;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_60381 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_60381[i]));
} else {
x__$2.forward.push((((i < links_60381.length))?(links_60381[i]):null));
}

if((i < links_60381.length)){
(links_60381[i] = x__$2);
} else {
links_60381.push(x__$2);
}
...
var i_60383 = (0);
while(true){
if((i_60383 <= self__.level)){
var links_60384 = (update[i_60383]).forward;
if((x__$1 === (((i_60383 < links_60384.length))?(links_60384[i_60383]):null))){
(links_60384[i_60383] = (x__$1.forward[i_60383]));

var G__60385 = (i_60383 + (1));
i_60383 = G__60385;
continue;
} else {
var G__60386 = (i_60383 + (1));
i_60383 = G__60386;
continue;
}
} else {
...
var G__60388 = nx;
var G__60389 = (level__$1 - (1));
x = G__60388;
level__$1 = G__60389;
continue;
} else {
var G__60390 = x;
var G__60391 = (level__$1 - (1));
x = G__60390;
level__$1 = G__60391;
continue;
}
