...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24541 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24541(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24545 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24545(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24546 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24546(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24547 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24547(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24548 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24548(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24549 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24549(reader);
}
});
...
var G__24592 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__24593 = s.append(c);
c = G__24592;
s = G__24593;
continue;
}
