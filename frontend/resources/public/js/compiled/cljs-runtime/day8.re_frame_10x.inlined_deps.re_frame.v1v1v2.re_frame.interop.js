...
return [(function (){var pred__22589 = cljs.core.instance_QMARK_;
var expr__22590 = reactive_val;
if(cljs.core.truth_((pred__22589.cljs$core$IFn$_invoke$arity$2 ? pred__22589.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__22590) : pred__22589.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__22590)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22589.cljs$core$IFn$_invoke$arity$2 ? pred__22589.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__22590) : pred__22589.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__22590)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22589.cljs$core$IFn$_invoke$arity$2 ? pred__22589.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__22590) : pred__22589.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__22590)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22589.cljs$core$IFn$_invoke$arity$2 ? pred__22589.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__22590) : pred__22589.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__22590)))){
return "tr";
} else {
return "other";
}
