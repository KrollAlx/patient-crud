...
var len__5769__auto___58092 = arguments.length;
var i__5770__auto___58094 = (0);
while(true){
if((i__5770__auto___58094 < len__5769__auto___58092)){
args__5775__auto__.push((arguments[i__5770__auto___58094]));

var G__58095 = (i__5770__auto___58094 + (1));
i__5770__auto___58094 = G__58095;
continue;
} else {
}
break;
...
(day8.re_frame_10x.panels.settings.views.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__58065){
var map__58066 = p__58065;
var map__58066__$1 = cljs.core.__destructure_map(map__58066);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58066__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58066__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58066__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58066__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
(day8.re_frame_10x.panels.settings.views.closeable_text_box.cljs$lang$applyTo = (function (seq58064){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),follows_events_QMARK_,new cljs.core.Keyword(null,"label","label",1718410804),"sync app-db with epoch navigation",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__58068_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","app-db-follows-events?","day8.re-frame-10x.panels.settings.events/app-db-follows-events?",-1040848496),p1__58068_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.panels.settings.views.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.panels.settings.views.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__5523__auto__ = (function day8$re_frame_10x$panels$settings$views$render_$_iter__58078(s__58079){
return (new cljs.core.LazySeq(null,(function (){
var s__58079__$1 = s__58079;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__58079__$1);
if(temp__5804__auto__){
var s__58079__$2 = temp__5804__auto__;
...
var item = cljs.core._nth(c__5521__auto__,i__58080);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__58081,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__58080,id,item,c__5521__auto__,size__5522__auto__,b__58081,s__58079__$2,temp__5804__auto__,ambiance){
return (function (){
...
});})(i__58080,id,item,c__5521__auto__,size__5522__auto__,b__58081,s__58079__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__58080,id,item,c__5521__auto__,size__5522__auto__,b__58081,s__58079__$2,temp__5804__auto__,ambiance){
return (function (p1__58069_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-ignored-event","day8.re-frame-10x.panels.settings.events/update-ignored-event",789804124),id,p1__58069_SHARP_], null));
});})(i__58080,id,item,c__5521__auto__,size__5522__auto__,b__58081,s__58079__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__58101 = (i__58080 + (1));
i__58080 = G__58101;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58081),day8$re_frame_10x$panels$settings$views$render_$_iter__58078(cljs.core.chunk_rest(s__58079__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58081),null);
}
} else {
var item = cljs.core.first(s__58079__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__58079__$2,temp__5804__auto__,ambiance){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","remove-ignored-event","day8.re-frame-10x.panels.settings.events/remove-ignored-event",252246704),id], null));
});})(id,item,s__58079__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__58079__$2,temp__5804__auto__,ambiance){
return (function (p1__58069_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-ignored-event","day8.re-frame-10x.panels.settings.events/update-ignored-event",789804124),id,p1__58069_SHARP_], null));
});})(id,item,s__58079__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$panels$settings$views$render_$_iter__58078(cljs.core.rest(s__58079__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.panels.settings.views.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.panels.settings.views.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__5523__auto__ = (function day8$re_frame_10x$panels$settings$views$render_$_iter__58083(s__58084){
return (new cljs.core.LazySeq(null,(function (){
var s__58084__$1 = s__58084;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__58084__$1);
if(temp__5804__auto__){
var s__58084__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58084__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__58084__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__58086 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__58085 = (0);
while(true){
if((i__58085 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__58085);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__58086,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__58085,id,item,c__5521__auto__,size__5522__auto__,b__58086,s__58084__$2,temp__5804__auto__,ambiance){
return (function (){
...
});})(i__58085,id,item,c__5521__auto__,size__5522__auto__,b__58086,s__58084__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__58085,id,item,c__5521__auto__,size__5522__auto__,b__58086,s__58084__$2,temp__5804__auto__,ambiance){
return (function (p1__58070_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-filtered-view-trace","day8.re-frame-10x.panels.settings.events/update-filtered-view-trace",598201221),id,p1__58070_SHARP_], null));
});})(i__58085,id,item,c__5521__auto__,size__5522__auto__,b__58086,s__58084__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__58104 = (i__58085 + (1));
i__58085 = G__58104;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58086),day8$re_frame_10x$panels$settings$views$render_$_iter__58083(cljs.core.chunk_rest(s__58084__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58086),null);
}
} else {
var item = cljs.core.first(s__58084__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__58084__$2,temp__5804__auto__,ambiance){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","remove-filtered-view-trace","day8.re-frame-10x.panels.settings.events/remove-filtered-view-trace",2058604246),id], null));
});})(id,item,s__58084__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__58084__$2,temp__5804__auto__,ambiance){
return (function (p1__58070_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-filtered-view-trace","day8.re-frame-10x.panels.settings.events/update-filtered-view-trace",598201221),id,p1__58070_SHARP_], null));
});})(id,item,s__58084__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$panels$settings$views$render_$_iter__58083(cljs.core.rest(s__58084__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.label,new cljs.core.Keyword(null,"label","label",1718410804),"Remove low level trace"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"reagent","reagent",2131627322).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"reagent internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__58071_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","low-level-trace","day8.re-frame-10x.panels.settings.subs/low-level-trace",-929378536),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__58071_SHARP_], null));
})], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"re-frame internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__58072_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","low-level-trace","day8.re-frame-10x.panels.settings.subs/low-level-trace",-929378536),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__58072_SHARP_], null));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),open_inspectors_QMARK_,new cljs.core.Keyword(null,"label","label",1718410804),"open new inspectors by default",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__58073_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","open-new-inspectors?","day8.re-frame-10x.panels.settings.events/open-new-inspectors?",-1146109198),p1__58073_SHARP_], null));
