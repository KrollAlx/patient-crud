...
var o18652 = temp__5802__auto__;
var temp__5802__auto____$1 = (o18652["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o18653 = temp__5802__auto____$1;
return (o18653["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__17634__auto___19243 = t;
(o__17634__auto___19243["cljs$lang$ctorPrWriter"]).call(o__17634__auto___19243,t,writer);
}catch (e18720){var __19244 = e18720;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__18755 = num_code;
switch (G__18755) {
case (1):
return (185);
...
}catch (e18809){var _e__17641__auto__ = e18809;
return false;
}})())){
...
var vec__18813 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18813,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__18903){
var vec__18904 = p__18903;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18904,(0),null);
...
var G__19255 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__19256 = cljs.core.butlast(remaining_tokens);
name_tokens = G__19255;
remaining_tokens = G__19256;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq18901){
var G__18902 = cljs.core.first(seq18901);
var seq18901__$1 = cljs.core.next(seq18901);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18902,seq18901__$1);
}));
...
var vec__18935 = cljs.core.split_with((function (p1__18930_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__18930_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18935,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18935,(1),null);
...
var vec__18960 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18960,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18960,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__19259 = cljs.core.rest(remaining_tokens);
var G__19260 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__19259;
name_tokens = G__19260;
continue;
} else {
...
var vec__18998 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18998,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18998,(1),null);
var vec__19001 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19001,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19001,(1),null);
var vec__19004 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19004,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19004,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19004,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19004,(3),null);
...
var vec__19021 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19021,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__19033 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19033,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19033,(1),null);
var vec__19044 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19044,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19044,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__19049 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__19049) : devtools.munging.parse_fn_info_deep.call(null,G__19049));
})()));
}
} else {
return fn_info;
...
var G__19297 = (arity + (1));
var G__19298 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19061){
var vec__19062 = p__19061;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19062,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19062,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19065_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__19065_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19066_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__19066_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___19306 = arguments.length;
var i__5770__auto___19307 = (0);
while(true){
if((i__5770__auto___19307 < len__5769__auto___19306)){
args__5775__auto__.push((arguments[i__5770__auto___19307]));

var G__19308 = (i__5770__auto___19307 + (1));
i__5770__auto___19307 = G__19308;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19070){
var vec__19071 = p__19070;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19071,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19067){
var G__19068 = cljs.core.first(seq19067);
var seq19067__$1 = cljs.core.next(seq19067);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19068,seq19067__$1);
}));
...
var map__19093 = options;
var map__19093__$1 = cljs.core.__destructure_map(map__19093);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19093__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19093__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19093__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19093__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19094 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19094,(5),null);
...
}catch (e19141){var _e__17641__auto__ = e19141;
...
var G__19333 = (obj[cljs.core.first(path)]);
var G__19334 = cljs.core.rest(path);
obj = G__19333;
path = G__19334;
continue;
} else {
...
var _STAR_ = (function (accum,p__19194){
var vec__19195 = p__19194;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19195,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19195,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19210){
var vec__19211 = p__19210;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19211,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19211,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19211,(2),null);
...
var post_process = (function (p__19219){
var vec__19220 = p__19219;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19220,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19220,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19214_SHARP_){
return (obj[cljs.core.first(p1__19214_SHARP_)]);
}),sorted_matches);
