...
var len__5769__auto___21315 = arguments.length;
var i__5770__auto___21316 = (0);
while(true){
if((i__5770__auto___21316 < len__5769__auto___21315)){
args__5775__auto__.push((arguments[i__5770__auto___21316]));

var G__21317 = (i__5770__auto___21316 + (1));
i__5770__auto___21316 = G__21317;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__21091_21318 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__21092_21319 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__21093_21320 = true;
var _STAR_print_fn_STAR__temp_val__21094_21321 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__21093_21320);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__21094_21321);

try{var _STAR_print_level_STAR__orig_val__21098_21322 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__21099_21323 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__21099_21323);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__21098_21322);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__21092_21319);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__21091_21318);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq21083){
...
var new_formatters = current_formatters.filter((function (p1__21174_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__21174_SHARP_)));
}));
...
var G__21181_21325 = f;
var target__17639__auto___21326 = G__21181_21325;
if(cljs.core.truth_(target__17639__auto___21326)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21181_21325)].join(''),"\n","target__17639__auto__"].join('')));
}

(target__17639__auto___21326["toString"] = (function (){
...
var G__21183_21327 = "%c%s";
var G__21184_21328 = "color:transparent";
var G__21185_21329 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__21183_21327,G__21184_21328,G__21185_21329) : f.call(null,G__21183_21327,G__21184_21328,G__21185_21329));
...
var vec__21223 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21223,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21223,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__21333__delegate = function (add_fmt,add_args){
...
var G__21333 = function (add_fmt,var_args){
var add_args = null;
...
while (G__21334__i < G__21334__a.length) {G__21334__a[G__21334__i] = arguments[G__21334__i + 1]; ++G__21334__i;}
  add_args = new cljs.core.IndexedSeq(G__21334__a,0,null);
} 
return G__21333__delegate.call(this,add_fmt,add_args);};
G__21333.cljs$lang$maxFixedArity = 1;
G__21333.cljs$lang$applyTo = (function (arglist__21335){
var add_fmt = cljs.core.first(arglist__21335);
var add_args = cljs.core.rest(arglist__21335);
return G__21333__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq21200){
...
var G__21203 = cljs.core.first(seq21200__$2);
var seq21200__$3 = cljs.core.next(seq21200__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21201,G__21202,G__21203,seq21200__$3);
}));
...
var seq__21265 = cljs.core.seq(features);
var chunk__21266 = null;
var count__21267 = (0);
var i__21268 = (0);
while(true){
if((i__21268 < count__21267)){
var feature = chunk__21266.cljs$core$IIndexed$_nth$arity$2(null,i__21268);
...
var G__21338 = seq__21265;
var G__21339 = chunk__21266;
var G__21340 = count__21267;
var G__21341 = (i__21268 + (1));
seq__21265 = G__21338;
chunk__21266 = G__21339;
count__21267 = G__21340;
i__21268 = G__21341;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__21265);
if(temp__5804__auto__){
var seq__21265__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__21265__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__21265__$1);
var G__21342 = cljs.core.chunk_rest(seq__21265__$1);
var G__21343 = c__5568__auto__;
var G__21344 = cljs.core.count(c__5568__auto__);
var G__21345 = (0);
seq__21265 = G__21342;
chunk__21266 = G__21343;
count__21267 = G__21344;
i__21268 = G__21345;
continue;
} else {
var feature = cljs.core.first(seq__21265__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__21352 = cljs.core.next(seq__21265__$1);
var G__21353 = null;
var G__21354 = (0);
var G__21355 = (0);
seq__21265 = G__21352;
chunk__21266 = G__21353;
count__21267 = G__21354;
i__21268 = G__21355;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o21304 = temp__5802__auto__;
return (o21304["version"]);
} else {
return null;
}
})() == null);
