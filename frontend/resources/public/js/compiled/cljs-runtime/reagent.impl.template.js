...
var G__26263 = o;
reagent.impl.template.goog$module$goog$object.set(G__26263,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__26318__delegate = function (args){
...
while (G__26319__i < G__26319__a.length) {G__26319__a[G__26319__i] = arguments[G__26319__i + 0]; ++G__26319__i;}
  args = new cljs.core.IndexedSeq(G__26319__a,0,null);
} 
...
var G__26264 = o;
reagent.impl.template.goog$module$goog$object.set(G__26264,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__26269 = props;
var G__26269__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26269,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__26269);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26269__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__26270 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26270,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__26270;
}
})(),id_class);
...
var G__26271 = (cljs.core.count(argv) - first_child);
switch (G__26271) {
case (0):
...
var vec__26273 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26273,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26273,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26273,(2),null);
...
var temp__5808__auto___26328 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26328 == null)){
} else {
var key_26329 = temp__5808__auto___26328;
(jsprops.key = key_26329);
}
...
var temp__5808__auto___26330 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___26330 == null)){
} else {
var key_26331 = temp__5808__auto___26330;
(jsprops.key = key_26331);
}
...
var temp__5808__auto___26332 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___26332 == null)){
} else {
var key_26333 = temp__5808__auto___26332;
(jsprops.key = key_26333);
}
...
var temp__5808__auto___26334 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26334 == null)){
} else {
var key_26335 = temp__5808__auto___26334;
(jsprops.key = key_26335);
}
...
var temp__5808__auto___26336 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___26336 == null)){
} else {
var key_26337 = temp__5808__auto___26336;
(jsprops.key = key_26337);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26289_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__26289_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__26290 = reagent.ratom.check_derefs((function (){
...
break;
default:
var G__26342 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__26343 = compiler;
v = G__26342;
compiler = G__26343;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template26303 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template26303 = (function (opts,id,fn_to_element,parse_fn,meta26304){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template26303.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26305,meta26304__$1){
var self__ = this;
var _26305__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template26303(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta26304__$1));
}));

(reagent.impl.template.t_reagent$impl$template26303.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26305){
var self__ = this;
var _26305__$1 = this;
return self__.meta26304;
}));

(reagent.impl.template.t_reagent$impl$template26303.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template26303.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template26303.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template26303.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template26303.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template26303.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta26304","meta26304",-489996832,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template26303.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template26303.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template26303");

(reagent.impl.template.t_reagent$impl$template26303.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template26303");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template26303.
 */
reagent.impl.template.__GT_t_reagent$impl$template26303 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template26303(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26304){
return (new reagent.impl.template.t_reagent$impl$template26303(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta26304));
});

}

return (new reagent.impl.template.t_reagent$impl$template26303(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
