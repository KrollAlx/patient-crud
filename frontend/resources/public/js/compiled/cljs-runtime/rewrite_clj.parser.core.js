...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32326 = cljs.core.get_global_hierarchy;
return (fexpr__32326.cljs$core$IFn$_invoke$arity$0 ? fexpr__32326.cljs$core$IFn$_invoke$arity$0() : fexpr__32326.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__32335_SHARP_){
var _STAR_delimiter_STAR__orig_val__32336 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__32337 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__32337);

try{return rewrite_clj.parser.core.parse_next(p1__32335_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__32336);
}}));
});
...
var G__32392 = (i__5770__auto___32391 + (1));
i__5770__auto___32391 = G__32392;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__32343){
var vec__32344 = p__32343;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32344,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq32338){
var G__32339 = cljs.core.first(seq32338);
var seq32338__$1 = cljs.core.next(seq32338);
var G__32340 = cljs.core.first(seq32338__$1);
var seq32338__$2 = cljs.core.next(seq32338__$1);
var G__32341 = cljs.core.first(seq32338__$2);
var seq32338__$3 = cljs.core.next(seq32338__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32339,G__32340,G__32341,seq32338__$3);
}));
...
var G__32354 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__32354)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__32354)){
...
return cljs.core.cons((function (){var G__32355 = rewrite_clj.reader.peek(reader);
switch (G__32355) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__32354)){
