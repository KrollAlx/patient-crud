...
if((c === "\n")){
var G__32035 = escape_QMARK_;
var G__32036 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__32035;
lines = G__32036;
continue;
} else {
buf.append(c);

var G__32037 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__32038 = lines;
escape_QMARK_ = G__32037;
lines = G__32038;
continue;
