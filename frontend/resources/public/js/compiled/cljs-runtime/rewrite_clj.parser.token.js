...
var G__32066 = (i__5770__auto___32065 + (1));
i__5770__auto___32065 = G__32066;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__32052){
var vec__32053 = p__32052;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32053,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__32047_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__32047_SHARP_) : allowed_QMARK_.call(null,p1__32047_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__32047_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq32049){
var G__32050 = cljs.core.first(seq32049);
var seq32049__$1 = cljs.core.next(seq32049);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32050,seq32049__$1);
}));
