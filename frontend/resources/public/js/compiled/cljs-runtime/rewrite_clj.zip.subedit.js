...
var zloc_SINGLEQUOTE_ = (function (){var G__40193 = zloc;
var G__40193__$1 = (((G__40193 == null))?null:rewrite_clj.custom_zipper.core.node(G__40193));
if((G__40193__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn_STAR_.cljs$core$IFn$_invoke$arity$2(G__40193__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__40194 = rewrite_clj.zip.subedit.subzip(zloc);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__40194) : f.call(null,G__40194));
})();
if((!((zloc_SINGLEQUOTE_ == null)))){
} else {
