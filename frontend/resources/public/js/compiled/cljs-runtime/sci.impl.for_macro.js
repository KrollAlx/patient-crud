...
var arg_count_45095 = (cljs.core.count(expr) - (1));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((2),arg_count_45095)){
} else {
sci.impl.utils.throw_error_with_location.cljs$core$IFn$_invoke$arity$2(["Wrong number of args (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(arg_count_45095),") passed to: clojure.core/for"].join(''),expr);
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__44954){
...
var err = (function() { 
var G__45097__delegate = function (msg){
...
while (G__45112__i < G__45112__a.length) {G__45112__a[G__45112__i] = arguments[G__45112__i + 0]; ++G__45112__i;}
  msg = new cljs.core.IndexedSeq(G__45112__a,0,null);
} 
return G__45097__delegate.call(this,msg);};
G__45097.cljs$lang$maxFixedArity = 0;
G__45097.cljs$lang$applyTo = (function (arglist__45113){
var msg = cljs.core.seq(arglist__45113);
return G__45097__delegate(msg);
});
G__45097.cljs$core$IFn$_invoke$arity$variadic = G__45097__delegate;
return G__45097;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__44973){
...
var bind = first__44981;
var first__44981__$1 = cljs.core.first(seq__44980__$1);
var seq__44980__$2 = cljs.core.next(seq__44980__$1);
var expr__$1 = first__44981__$1;
var mod_pairs = seq__44980__$2;
var vec__44982 = seq__44975__$1;
var vec__44985 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44982,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44985,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44985,(1),null);
var next_groups = vec__44982;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__44989){
...
var vec__44993 = first__44992;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44993,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44993,(1),null);
var pair = vec__44993;
var etc = seq__44991__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__44936__auto__","iterys__44936__auto__",1317617568,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__44937__auto__","fs__44937__auto__",-300472253,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__44936__auto__","iterys__44936__auto__",1317617568,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__44937__auto__","fs__44937__auto__",-300472253,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__44937__auto__","fs__44937__auto__",-300472253,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__45049){
...
var vec__45053 = first__45052;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45053,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45053,(1),null);
var pair = vec__45053;
var etc = seq__45051__$1;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(k,new cljs.core.Keyword(null,"let","let",-1282412701))){
