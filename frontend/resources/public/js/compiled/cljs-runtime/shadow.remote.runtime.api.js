...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60410 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_60410(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_60411 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_60411(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_60412 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_60412(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_60413 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_60413(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60414 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_60414(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60415 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_60415(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__60403,callback){
var map__60404 = p__60403;
var map__60404__$1 = cljs.core.__destructure_map(map__60404);
var input = map__60404__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60404__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60404__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
