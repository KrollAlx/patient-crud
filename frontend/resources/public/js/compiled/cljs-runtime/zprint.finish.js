...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__30786_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30786_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__30786_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__30787){
var vec__30788 = p__30787;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30788,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30788,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__30791,s,color,element,idx){
var map__30792 = p__30791;
var map__30792__$1 = cljs.core.__destructure_map(map__30792);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30792__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30792__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30792__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__30795 = (function (){var or__5045__auto__ = color;
...
var fexpr__30794 = (function (){var G__30796 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__30796) : style_map.call(null,G__30796));
})();
return (fexpr__30794.cljs$core$IFn$_invoke$arity$1 ? fexpr__30794.cljs$core$IFn$_invoke$arity$1(G__30795) : fexpr__30794.call(null,G__30795));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__30798){
var vec__30800 = p__30798;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30800,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__30804){
var vec__30805 = p__30804;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30805,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30805,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30805,(2),null);
...
var G__30984 = cljs.core.next(ssv);
var G__30985 = (this_ssv == null);
var G__30986 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__30987 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__30984;
doing_nil_QMARK_ = G__30985;
last_elide = G__30986;
out = G__30987;
continue;
}
...
var vec__30820 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30820,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30820,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30820,(2),null);
...
var G__30988 = cljs.core.next(remaining_cvec);
var G__30989 = new_idx;
var G__30990 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__30988;
idx = G__30989;
out = G__30990;
continue;
}
...
var G__30993 = cljs.core.next(ss_vec);
...
var G__30995 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__30996 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__30993;
current = G__30994;
pos = G__30995;
out = G__30996;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__30879,cursor_vec){
var vec__30880 = p__30879;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30880,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30880,(1),null);
var focus_vec = vec__30880;
...
var vec__30888 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30888,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30888,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__30895){
var vec__30897 = p__30895;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30897,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30897,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__30921,existing_count){
var vec__30922 = p__30921;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30922,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30922,(1),null);
...
return cljs.core.filterv((function (p1__30911_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__30911_SHARP_))));
...
var vec__30960 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30960,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30960,(1),null);
var cvec_element = vec__30960;
if((cvec_element == null)){
var G__31000 = cljs.core.next(cvec_nl);
var G__31001 = (idx + (1));
var G__31002 = start;
var G__31003 = out;
cvec_nl = G__31000;
...
var G__31004 = cljs.core.next(cvec_nl);
var G__31005 = (idx + (1));
var G__31006 = idx;
var G__31007 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31004;
idx = G__31005;
start = G__31006;
out = G__31007;
...
var G__31008 = cljs.core.next(cvec_nl);
var G__31009 = (idx + (1));
var G__31010 = (idx + (1));
var G__31011 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31008;
idx = G__31009;
start = G__31010;
out = G__31011;
...
var G__31012 = cljs.core.next(cvec_nl);
var G__31013 = (idx + (1));
var G__31014 = idx;
var G__31015 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31012;
idx = G__31013;
start = G__31014;
out = G__31015;
...
var G__31017 = cljs.core.next(cvec_nl);
var G__31018 = (idx + (1));
var G__31019 = start;
var G__31020 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31017;
idx = G__31018;
start = G__31019;
out = G__31020;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__30967_SHARP_,p2__30966_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__30966_SHARP_)){
return cljs.core.reduced(p1__30967_SHARP_);
} else {
return (p1__30967_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__30968,p__30969){
var vec__30970 = p__30968;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30970,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30970,(1),null);
var vec__30973 = p__30969;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30973,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30973,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__30981,cvec,focus_vec){
var map__30982 = p__30981;
var map__30982__$1 = cljs.core.__destructure_map(map__30982);
var options = map__30982__$1;
var map__30983 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30982__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__30983__$1 = cljs.core.__destructure_map(map__30983);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30983__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30983__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30983__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30980_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__30980_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
