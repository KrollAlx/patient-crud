...
var G__42509 = rewrite_clj.zip.next(n);
loc = G__42509;
continue;
} else {
var G__42510 = rewrite_clj.zip.next(loc);
loc = G__42510;
continue;
}
} else {
var G__42511 = rewrite_clj.zip.next(loc);
loc = G__42511;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__42489 = zloc;
var G__42489__$1 = (((G__42489 == null))?null:rewrite_clj.zip.node(G__42489));
if((G__42489__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__42489__$1);
}
})())));
});
/**
...
var G__42512 = rewrite_clj.zip.down(nloc);
nloc = G__42512;
continue;
}
break;
...
var G__42513 = rewrite_clj.zip.right(nloc);
var G__42514 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__42513;
out = G__42514;
continue;
} else {
...
var G__42520 = rewrite_clj.zip.right(replaced_loc);
var G__42521 = cljs.core.next(new_loc);
var G__42522 = replaced_loc;
nloc = G__42520;
new_loc = G__42521;
last_loc = G__42522;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__42505_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__42505_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__42505_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
